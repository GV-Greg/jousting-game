...
import MedButton from '@/components/BaseButton.vue'
...
<template>
  ...
  <div v-if="showOptions" class="medieval-panel">
    <h2 class="medieval-title">Options</h2>

    <div class="flex justify-between items-center my-6">
      <label class="text-lg font-medieval">Sons</label>
      <MedButton
        :text="settingsStore.soundEnabled ? 'Activés' : 'Désactivés'"
        :color="settingsStore.soundEnabled ? 'success' : 'danger'"
